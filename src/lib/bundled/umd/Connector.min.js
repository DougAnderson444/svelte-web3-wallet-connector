(function (global, factory) {
    ...
    function add_css$1(target) {
    	append_styles(target, "svelte-hjenm0", "svg.svelte-hjenm0{width:auto;height:2.5em;display:block}");
    }
    ...
    function add_css(target) {
    	append_styles(target, "svelte-qv34lx", "div.svelte-qv34lx{--background:#161616}.top.svelte-qv34lx{display:flex}iframe.svelte-qv34lx{border:none}.iframe.svelte-qv34lx{display:flex;height:100%}.logo.svelte-qv34lx{flex:0 0 auto;position:relative;opacity:1;height:100%;display:flex;align-items:center;justify-content:center;padding:calc(var(--spacing) / 2)}.url-input.svelte-qv34lx{position:fixed;top:var(--spacing);right:var(--spacing);background:var(--background);border:0.5px solid #333;display:flex;flex-direction:column;align-items:stretch;border-radius:8px;width:auto;min-width:20em;max-width:800px;--spacing:1em;padding:var(--spacing);filter:drop-shadow(2px 4px 6px rgba(133, 133, 133, 0.5));max-height:95vh}.url-input.svelte-qv34lx:hover{cursor:move}.url.svelte-qv34lx{padding:var(--spacing);padding-right:0;flex:1 1 0;min-width:0;outline:none;background-color:var(--background)}.green-line.svelte-qv34lx{border-bottom:4px solid #0eff02;margin-left:var(--spacing);flex:1;position:relative;top:-8px}.actions.svelte-qv34lx{display:flex}.actions.svelte-qv34lx:last-child{padding-right:calc(var(--spacing) / 2)}.action.dim.svelte-qv34lx{opacity:0.9;color:#e0f7fa}.connected.svelte-qv34lx{color:greenyellow;text-shadow:1px 1px 3px black}.disconnected.svelte-qv34lx{color:#e0f7fa;text-shadow:1px 1px 3px black}input.svelte-qv34lx{flex:1 1 0;color:whitesmoke;background:none;border:none;margin:0;padding:0;font-size:1em;min-width:40ch;max-width:50ch}");
    }

    // (81:3) {#if wallet?.address || inputUrl}
    function create_if_block(ctx) {
    	...
    	let div_transition;
    	let current;
    	iconbutton = new WalletSelectorIcons({ props: { icon: /*popupIcon*/ ctx[9] } });
    	iconbutton.$on("click", /*togglePopup*/ ctx[12]);

    	return {
    		c() {
    			div = element("div");
    			create_component(iconbutton.$$.fragment);
    			attr(div, "class", div_class_value = "" + (null_to_empty(!/*wallet*/ ctx[0]?.keepPopup ? 'action dim' : 'action') + " svelte-qv34lx"));
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    		...
    		p(ctx, dirty) {
    			...
    			if (dirty & /*popupIcon*/ 512) iconbutton_changes.icon = /*popupIcon*/ ctx[9];
    			iconbutton.$set(iconbutton_changes);

    			if (!current || dirty & /*wallet*/ 1 && div_class_value !== (div_class_value = "" + (null_to_empty(!/*wallet*/ ctx[0]?.keepPopup ? 'action dim' : 'action') + " svelte-qv34lx"))) {
    ...
    // (97:4) <IconButton       icon={connectionIcon}       on:click={() => {        wallet?.address ? disconnect() : connect();       }}       >
    function create_default_slot(ctx) {
    	let span;

    	let t_value = (/*data*/ ctx[7].loading || !/*src*/ ctx[3]
    	? 'Loading...'
    	: 'Load') + "";
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			if (dirty & /*data, src*/ 136 && t_value !== (t_value = (/*data*/ ctx[7].loading || !/*src*/ ctx[3]
    			? 'Loading...'
    ...
    function create_fragment(ctx) {
    	...
    	iconbutton = new WalletSelectorIcons({
    			props: {
    				icon: /*connectionIcon*/ ctx[8],
    				$$slots: { default: [create_default_slot] },
    				$$scope: { ctx }
    			}
    		});

    	iconbutton.$on("click", /*click_handler*/ ctx[17]);
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "actions logo svelte-qv34lx");
    			attr(a, "href", "https://PeerPiper.io");
    			attr(a, "target", "_blank");
    			attr(a, "rel", "noreferrer");
    			attr(input, "class", "url svelte-qv34lx");
    			attr(input, "placeholder", placeholder);
    			attr(input, "style", input_style_value = `width: ${Array.from(/*inputUrl*/ ctx[1]).length}em;`);
    			attr(span, "class", "green-line svelte-qv34lx");
    			set_style(div1, "display", "flex");
    			set_style(div1, "flex-direction", "column");
    			attr(div1, "class", "svelte-qv34lx");

    			attr(div2, "class", div2_class_value = "" + (null_to_empty((/*data*/ ctx[7]?.loading)
    			? 'action dim'
    			: /*wallet*/ ctx[0]?.address
    				? ' connected '
    				: ' disconnected ') + " svelte-qv34lx"));

    			attr(div3, "class", "actions svelte-qv34lx");
    			attr(div4, "class", "top svelte-qv34lx");
    			set_style(div4, "--topOffsetHeight", /*topOffsetHeight*/ ctx[5]);
    			add_render_callback(() => /*div4_elementresize_handler*/ ctx[18].call(div4));
    			...
    			attr(iframe_1, "class", "svelte-qv34lx");
    			attr(div5, "class", "iframe svelte-qv34lx");
    			set_style(div5, "height", /*iframeParentHeight*/ ctx[6] + "px");
    			attr(div6, "class", "url-input svelte-qv34lx");
    			set_style(div6, "height", "calc(var(--spacing) * 2 + " + /*topOffsetHeight*/ ctx[5] + "px + " + /*iframeParentHeight*/ ctx[6] + "px + 2px)");
    		},
    		m(target, anchor) {
    			...
    			div4_resize_listener = add_resize_listener(div4, /*div4_elementresize_handler*/ ctx[18].bind(div4));
    			append(div6, t4);
    			append(div6, div5);
    			append(div5, iframe_1);
    			/*iframe_1_binding*/ ctx[19](iframe_1);
    			current = true;

    			if (!mounted) {
    				dispose = [
    					listen(window_1, "keydown", /*handleKeydown*/ ctx[13]),
    		...
    		p(ctx, [dirty]) {
    			if (!current || dirty & /*inputUrl*/ 2 && input_style_value !== (input_style_value = `width: ${Array.from(/*inputUrl*/ ctx[1]).length}em;`)) {
    			...
    			const iconbutton_changes = {};
    			if (dirty & /*connectionIcon*/ 256) iconbutton_changes.icon = /*connectionIcon*/ ctx[8];

    			if (dirty & /*$$scope, wallet, data, src*/ 4194441) {
    				iconbutton_changes.$$scope = { dirty, ctx };
    			}

    			iconbutton.$set(iconbutton_changes);

    			if (!current || dirty & /*data, wallet*/ 129 && div2_class_value !== (div2_class_value = "" + (null_to_empty((/*data*/ ctx[7]?.loading)
    			? 'action dim'
    			: /*wallet*/ ctx[0]?.address
    				? ' connected '
    				: ' disconnected ') + " svelte-qv34lx"))) {
    			...
    			if (!current || dirty & /*iframeParentHeight*/ 64) {
    				set_style(div5, "height", /*iframeParentHeight*/ ctx[6] + "px");
    			}

    			if (!current || dirty & /*topOffsetHeight, iframeParentHeight*/ 96) {
    				set_style(div6, "height", "calc(var(--spacing) * 2 + " + /*topOffsetHeight*/ ctx[5] + "px + " + /*iframeParentHeight*/ ctx[6] + "px + 2px)");
    			}
    		},
    		i(local) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let connectionIcon;
    	let { wallet } = $$props;
    	let { inputUrl = 'http://localhost:8080/' } = $$props;
    	let src = inputUrl;
    	let iframe;
    	let focused;
    	...
    	async function handleIframeLoad() {
    		$$invalidate(7, data.loading = false, data);
    		...
    		const connection = connectToChild({
    			...
    			methods: {
    				setIframeParentHeight(height) {
    					$$invalidate(6, iframeParentHeight = height);
    					return;
    				}
    			}
    		});
    	...
    	const connect = () => {
    		...
    		$$invalidate(7, data.loading = true, data);
    	};
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*wallet*/ 1) {
    			$$invalidate(9, popupIcon = (wallet?.keepPopup) ? 'close' : 'launch');
    		}

    		if ($$self.$$.dirty & /*wallet*/ 1) {
    			$$invalidate(8, connectionIcon = (wallet?.address) ? 'unplug' : 'plug');
    		}
    	};
